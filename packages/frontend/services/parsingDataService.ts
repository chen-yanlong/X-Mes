...
export function findAttestation(friendAddress: string, friendChain: string, attestations: any[]) {
  ...
  for (const att of attestations) {
    ...
    if(parsedData?.friendAddress == friendAddress && parsedData?.chain == friendChain) {
      return parsedData;
    }
  }
